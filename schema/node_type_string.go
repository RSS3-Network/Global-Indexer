...
const _NodeTypeName = "alphabetanormal"

var _NodeTypeIndex = [...]uint8{0, 5, 9, 15}

const _NodeTypeLowerName = "alphabetanormal"
...
func _NodeTypeNoOp() {
	...
	_ = x[NodeTypeAlpha-(0)]
	_ = x[NodeTypeBeta-(1)]
	_ = x[NodeTypeNormal-(2)]
}

var _NodeTypeValues = []NodeType{NodeTypeAlpha, NodeTypeBeta, NodeTypeNormal}
...
var _NodeTypeNameToValueMap = map[string]NodeType{
	...
	_NodeTypeName[9:15]:      NodeTypeNormal,
	_NodeTypeLowerName[9:15]: NodeTypeNormal,
}
