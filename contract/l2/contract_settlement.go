...
// DistributeRewards is a paid mutator transaction binding the contract method 0x6e70c420.
//
// Solidity: function distributeRewards(uint256 epoch, address[] nodeAddrs, uint256[] requestFees, uint256[] operationRewards) returns()
func (_Settlement *SettlementTransactor) DistributeRewards(opts *bind.TransactOpts, epoch *big.Int, nodeAddrs []common.Address, requestFees []*big.Int, operationRewards []*big.Int) (*types.Transaction, error) {
	return _Settlement.contract.Transact(opts, "distributeRewards", epoch, nodeAddrs, requestFees, operationRewards)
}

// DistributeRewards is a paid mutator transaction binding the contract method 0x6e70c420.
//
// Solidity: function distributeRewards(uint256 epoch, address[] nodeAddrs, uint256[] requestFees, uint256[] operationRewards) returns()
func (_Settlement *SettlementSession) DistributeRewards(epoch *big.Int, nodeAddrs []common.Address, requestFees []*big.Int, operationRewards []*big.Int) (*types.Transaction, error) {
	return _Settlement.Contract.DistributeRewards(&_Settlement.TransactOpts, epoch, nodeAddrs, requestFees, operationRewards)
}

// DistributeRewards is a paid mutator transaction binding the contract method 0x6e70c420.
//
// Solidity: function distributeRewards(uint256 epoch, address[] nodeAddrs, uint256[] requestFees, uint256[] operationRewards) returns()
func (_Settlement *SettlementTransactorSession) DistributeRewards(epoch *big.Int, nodeAddrs []common.Address, requestFees []*big.Int, operationRewards []*big.Int) (*types.Transaction, error) {
	return _Settlement.Contract.DistributeRewards(&_Settlement.TransactOpts, epoch, nodeAddrs, requestFees, operationRewards)
}
...
//
// Solidity: function initialize(address staking, address oracleAccount, uint256 startTime, uint256 operationRewardsPercent, uint256 startEpoch) returns()
func (_Settlement *SettlementTransactor) Initialize(opts *bind.TransactOpts, staking common.Address, oracleAccount common.Address, startTime *big.Int, operationRewardsPercent *big.Int, startEpoch *big.Int) (*types.Transaction, error) {
	return _Settlement.contract.Transact(opts, "initialize", staking, oracleAccount, startTime, operationRewardsPercent, startEpoch)
}

// Initialize is a paid mutator transaction binding the contract method 0xd13f90b4.
//
// Solidity: function initialize(address staking, address oracleAccount, uint256 startTime, uint256 operationRewardsPercent, uint256 startEpoch) returns()
func (_Settlement *SettlementSession) Initialize(staking common.Address, oracleAccount common.Address, startTime *big.Int, operationRewardsPercent *big.Int, startEpoch *big.Int) (*types.Transaction, error) {
	return _Settlement.Contract.Initialize(&_Settlement.TransactOpts, staking, oracleAccount, startTime, operationRewardsPercent, startEpoch)
}

// Initialize is a paid mutator transaction binding the contract method 0xd13f90b4.
//
// Solidity: function initialize(address staking, address oracleAccount, uint256 startTime, uint256 operationRewardsPercent, uint256 startEpoch) returns()
func (_Settlement *SettlementTransactorSession) Initialize(staking common.Address, oracleAccount common.Address, startTime *big.Int, operationRewardsPercent *big.Int, startEpoch *big.Int) (*types.Transaction, error) {
	return _Settlement.Contract.Initialize(&_Settlement.TransactOpts, staking, oracleAccount, startTime, operationRewardsPercent, startEpoch)
}
