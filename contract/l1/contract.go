...
//go:generate go run --mod=mod github.com/ethereum/go-ethereum/cmd/abigen@v1.13.5 --abi ./abi/Billing.abi --pkg l1 --type Billing --out contract_billing.go
...
var (
	...
	AddressBillingProxy = common.HexToAddress("0x0D87956500ecbC17A6FA63093B6830458A4aD000") // https://sepolia.etherscan.io/address/0x0D87956500ecbC17A6FA63093B6830458A4aD000
)
