...
//
// Solidity: function getPoolInfo() view returns(uint256 totalOperatingPoolTokens, uint256 totalStakingPoolTokens, uint256 treasuryAmount)
func (_Staking *StakingCaller) GetPoolInfo(opts *bind.CallOpts) (struct {
	TotalOperatingPoolTokens *big.Int
	...
	outstruct.TotalOperatingPoolTokens = *abi.ConvertType(out[0], new(*big.Int)).(**big.Int)
