...
create index if not exists "idx_id" on "bridge"."events" (id);

create index if not exists "idx_events_chain_id_block_number" on "bridge"."events" (chain_id, block_number);
...
create index if not exists "idx_transactions_sender" on "bridge"."transactions" (sender);

create index if not exists "idx_transactions_address" on "bridge"."transactions" (sender, receiver);

create index if not exists "idx_transactions_receiver" on "bridge"."transactions" (receiver);

create index if not exists "idx_transactions_chain_id_block_number" on "bridge"."transactions" (chain_id, block_number);

create index if not exists "idx_transactions_order" on "bridge"."transactions" (block_timestamp desc, block_number desc, transaction_index desc);
...
create index if not exists "events_index_node_id" on "node"."events" (node_id);

create index if not exists "events_index_address" on "node"."events" (address_from, address_to);
...
create index if not exists "operator_profit_snapshots_operation_pool_idx" on "node"."operator_profit_snapshots" (operation_pool desc);

create index if not exists "operator_profit_snapshots_epoch_id_idx" on "node"."operator_profit_snapshots" (epoch_id desc);

create index if not exists "operator_profit_snapshots_id_idx" on "node"."operator_profit_snapshots" (id desc);

create index if not exists "operator_profit_snapshots_date_idx" on "node"."operator_profit_snapshots" (date);
...
create index if not exists "apy_snapshots_date_idx" on "node"."apy_snapshots" (date);
...
create index if not exists "idx_transactions_block_number" on "stake"."transactions" (block_number);

create index if not exists "idx_transactions_order" on "stake"."transactions" (block_timestamp desc, block_number desc, transaction_index desc);
...
create index if not exists "idx_id" on "stake"."events" (id);
...
create index if not exists "idx_events_block_number" on "stake"."events" (block_number);
...
create index if not exists "idx_owner_node_value_finalized" on "stake"."chips" (owner, node, value, finalized);

create index if not exists "idx_block_number" on "stake"."chips" (block_number);

create index if not exists "idx_node" on "stake"."chips" (node);

create index if not exists "idx_owner" on "stake"."chips" (owner);
...
create index if not exists "profit_snapshots_date_idx" on "stake"."profit_snapshots" (date);

create index if not exists "profit_snapshots_total_chip_amounts_idx" on "stake"."profit_snapshots" (total_chip_amounts desc);

create index if not exists "profit_snapshots_epoch_id_idx" on "stake"."profit_snapshots" (epoch_id desc, id desc);

create index if not exists "profit_snapshots_id_idx" on "stake"."profit_snapshots" (id);

create index if not exists "profit_snapshots_total_chip_values_idx" on "stake"."profit_snapshots" (total_chip_values desc);
...
create index if not exists "idx_created_at" on "node_info" (address asc, created_at desc);
...
create index if not exists "idx_indexes_created_at" on "node_stat" (created_at);

create index if not exists "idx_indexes_epoch_invalid_request_count" on "node_stat" (epoch_invalid_request_count);
...
create index if not exists "average_tax_rate_submissions_transaction_hash_idx" on "average_tax_rate_submissions" (transaction_hash);

create index if not exists "average_tax_rate_submissions_id_idx" on "average_tax_rate_submissions" (id desc);

create index if not exists "average_tax_rate_submissions_epoch_id_idx" on "average_tax_rate_submissions" (epoch_id desc);
...
create index if not exists "idx_node" on "node_invalid_response" (node asc, created_at desc);

create index if not exists "idx_request" on "node_invalid_response" (request asc, created_at desc);
...
create index if not exists "idx_epoch_item_node_address" on "node_reward_record" (node_address);

create index if not exists "idx_epoch_item_epoch_id" on "node_reward_record" (epoch_id);
