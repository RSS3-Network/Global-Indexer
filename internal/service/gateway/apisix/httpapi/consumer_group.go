...
const CONSUMER_GROUP_API_BASE = "/apisix/admin/consumer_groups"
...
func (s *HTTPAPIService) CheckConsumerGroup(userAddress string) (*ConsumerGroupResponse, error) {
	req, err := http.NewRequest("GET",
		fmt.Sprintf("%s%s/%s", s.Config.APISixAdminEndpoint, CONSUMER_GROUP_API_BASE, userAddress),
		nil,
	)
	if err != nil {
		return nil, err
...
func (s *HTTPAPIService) NewConsumerGroup(userAddress string) error {
...
func (s *HTTPAPIService) DeleteConsumerGroup(userAddress string) error {
...
func (s *HTTPAPIService) PauseConsumerGroup(userAddress string) error {
	...
	req, err := http.NewRequest("PATCH",
		fmt.Sprintf("%s%s/%s/plugins", s.Config.APISixAdminEndpoint, CONSUMER_GROUP_API_BASE, userAddress),
		bytes.NewReader(reqBytes),
	)
	if err != nil {
		return err
...
func (s *HTTPAPIService) ResumeConsumerGroup(userAddress string) error {
	// Remove all plugins
